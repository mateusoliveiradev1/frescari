...
- [ ] Executar varredura completa do web core rota por rota.
  ...
  Status notes: existe base de E2E em `apps/web/playwright.config.ts`, mas o coverage atual em `apps/web/e2e` esta concentrado em `admin-usuarios.spec.ts`, nao no core web rota por rota.
