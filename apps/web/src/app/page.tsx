  ...
  return (
    <div className="flex flex-col min-h-screen bg-cream selection:bg-forest/20 selection:text-forest">
      ...
      <section className="relative pt-20 pb-28 overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-[1fr_480px] gap-16 items-center">
          {/* Left — text */}
          <div className="space-y-8 max-w-2xl">
            ...
            {/* Headline */}
            <h1 className="font-display text-6xl sm:text-7xl lg:text-[82px] font-black text-soil leading-[0.92] tracking-tight">
              Compre{" "}
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              <div
                key={i}
                className="group p-8 bg-cream border border-soil/8 rounded-sm shadow-card hover:-translate-y-1 hover:shadow-card-hover transition-all duration-200 cursor-default"
              >
                {/* Icon */}
      ...
      <section className="py-24 bg-forest">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="space-y-3">
            ...
            <h2 className="font-display text-4xl sm:text-5xl font-black text-cream italic leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-3 flex-shrink-0">
            ...
            <Link href="/auth/register">
              <Button size="lg"
                className="bg-cream text-forest border-cream hover:bg-cream-dark hover:border-cream-dark">
                Criar Conta Grátis
              </Button>
            </Link>
          </div>
