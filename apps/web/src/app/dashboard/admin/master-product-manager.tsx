...
export function MasterProductManager() {
  ...
  const updateMasterProduct = trpc.admin.updateMasterProduct.useMutation({
    ...
    onError: (error) => {
      toast.error(
        error.message || "Nao foi possivel sincronizar produto e lotes.",
      );
    },
  });

  const isSaving =
    createMasterProduct.isPending || updateMasterProduct.isPending;
      ...
      <CardContent className="space-y-6 pt-6">
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-1.5">
              <label
                htmlFor="master-product-category"
            ...
            <div className="space-y-1.5">
              <label
                htmlFor="master-product-pricing"
                className={labelClassName}
              >
