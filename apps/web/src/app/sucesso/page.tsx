...
export const metadata: Metadata = {
    ...
    description: 'Seu pedido foi recebido com sucesso. O valor será cobrado após pesagem.',
};
            ...
            <div className="max-w-lg w-full text-center space-y-8">
                ...
                <div className="space-y-3">
                    ...
                    <p className="text-bark text-base md:text-lg leading-relaxed max-w-md mx-auto">
                        Obrigado por escolher a <span className="font-semibold text-forest">Frescari</span>.
                        Seu pedido está sendo preparado com carinho direto da fazenda.
                    </p>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-forest/10 p-6 shadow-sm space-y-4 text-left">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h3 className="font-sans text-sm font-bold text-soil">Pré-autorização</h3>
                            <p className="text-bark text-sm mt-1 leading-relaxed">
                                O limite do seu cartão foi <strong className="text-soil">pré-autorizado</strong>. O valor final será cobrado apenas após a <strong className="text-soil">pesagem exata</strong> dos produtos. Você pode ser cobrado um valor menor que o pré-autorizado.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h3 className="font-sans text-sm font-bold text-soil">Próximos passos</h3>
                            <p className="text-bark text-sm mt-1 leading-relaxed">
                                Nossos produtores começarão a separar seus itens. Você será notificado quando o pedido estiver a caminho.
                            </p>
                        </div>
                    </div>
                </div>
